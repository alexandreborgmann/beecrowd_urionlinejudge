...
Data: 14/04/2020
URI Online Judge | 1094 Experiências
...
Este laboratório em especial utiliza três tipos de cobaias: sapos, ratos e coelhos. Para obter estas informações, ela sabe exatamente o número de experimentos que foram realizados, o tipo de cobaia
...
Saída
Apresente o total de cobaias utilizadas, o total de cada tipo de cobaia utilizada e o percentual de cada uma em relação ao total de cobaias utilizadas, sendo que o percentual deve ser apresentado
...
for i in range(vezes):
    ...
    dadosCobaia[campos[1]]+=int(campos[0])
    total+=int(campos[0])

print("Total: {} cobaias".format(total))
for i in dadosCobaia:
    print("Total de {}: {}".format(tipoCobaia[i],dadosCobaia[i]))
for i in dadosCobaia:
    print("Percentual de {}: {:.2f} %".format(tipoCobaia[i],dadosCobaia[i]*100/total))